...
export const LinksTab: React.FC<LinksTabProps> = ({
    ...
    return (
        <div className="space-y-12 max-w-4xl mx-auto pb-20">
            ...
            {/* Secci�n Organizar Secciones del Perfil */}
            <section className="mt-12 animate-fade-in delay-[800ms]">
                <div className="bg-[#1a1b26] border border-gray-800 rounded-2xl p-6 shadow-xl">
                    <div className="flex items-center gap-3 mb-6 border-b border-gray-800 pb-4">
                        <div className="p-2 bg-[#ff6600]/10 rounded-lg text-[#ff6600]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12h18"/><path d="M3 6h18"/><path d="M3 18h18"/></svg>
                        </div>
                        <h3 className="font-bold text-xl text-white">Gesti�n de Arquitectura del Perfil</h3>
                    </div>
                    <p className="text-gray-500 text-sm mb-8 italic">
                        Organiza el flujo visual de tu perfil. Prioriza lo m�s importante para tus clientes arrastrando las secciones.
                    </p>
                    ...
                    {profileData.sectionOrder && profileData.sectionOrder.length > 0 ? (
                            ...
                            {profileData.sectionOrder
                                ...
                                .map((section, index) => {
                                    const sectionLabels = {
                                        ...
                                        links: 'Mis Enlaces Directos',
                                        products: 'Cat�logo de Productos',
                                        gallery: 'Galer�a Visual',
                                        files: 'Descargas Digitales',
                                        testimonials: 'Prueba Social (Testimonios)',
                                    ...
                                    return (
                                        <div 
                                            key={section.type} 
                                            className="group flex items-center justify-between p-4 bg-[#0f1016] rounded-2xl border border-gray-800 hover:border-[#ff6600]/30 transition-all"
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className="flex flex-col gap-1">
                                                    <button
                                                        ...
                                                        disabled={index === 0}
                                                        className="text-gray-700 hover:text-[#ff6600] disabled:opacity-10 transition-colors"
                                                    >
                                                ...
                                                <span className="text-white text-xs font-bold tracking-wide uppercase">{sectionLabels[section.type] || section.type}</span>
                                            </div>
                                            
                                            <div className="flex items-center gap-3">
                                                <span className={	ext-[10px] font-bold uppercase \}>
                        ...
                        <div className="py-12 bg-[#0f1016]/30 border border-gray-800 border-dashed rounded-2xl text-center">
                            <p className="text-gray-600 italic text-sm font-medium">Cargando arquitectura del perfil...</p>
                        </div>
                    )}
                        ...
                        <Button 
                            onClick={async () => {
                                ...
                                try {
                                    ...
                                    alert('Arquitectura del perfil actualizada con �xito.');
                                } catch (error) {
                                    console.error(error);
                                }
                            }}
                            className="bg-gray-800 hover:bg-gray-700 text-white text-xs px-10 h-12 rounded-full border border-gray-700 font-bold uppercase tracking-widest transition-all hover:scale-105 active:scale-95"
                        >
                            Confirmar Nueva Estructura
                        </Button>
                    </div>
                </div>
            </section>
